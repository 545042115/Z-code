...
export class EmbeddingManager {
  ...
  private isProjectUnderstandingQuery(query: string): boolean {
    return /杩欎釜椤圭洰鏄共浠€涔坾椤圭洰鏄共浠€涔坾椤圭洰鏄仛浠€涔坾浠嬬粛椤圭洰|椤圭洰绠€浠媩椤圭洰浠嬬粛|瑙ｉ噴椤圭洰|about this project|椤圭洰鍔熻兘|椤圭洰妯″潡|椤圭洰浣滅敤|椤圭洰璇存槑|椤圭洰鐢ㄩ€攟椤圭洰缁撴瀯|鐩綍缁撴瀯|椤圭洰鏋舵瀯|鍒嗘瀽椤圭洰|鍒嗘瀽鏋舵瀯|椤圭洰缁勭粐|鏌ョ湅.*椤圭洰.*浣滅敤|鏌ョ湅.*椤圭洰.*鍔熻兘|鏌ョ湅.*椤圭洰.*鐢ㄩ€攟褰撳墠椤圭洰.*浣滅敤|褰撳墠椤圭洰.*鍔熻兘|褰撳墠椤圭洰.*鐢ㄩ€攟椤圭洰姒傝堪|椤圭洰姒傚喌/i.test(query);
  }
