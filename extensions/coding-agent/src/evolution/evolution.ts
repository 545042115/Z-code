// Evolution — Phase 5 self-improvement loop.
//
...
// in `EvolutionPanel` (Apply/Reject buttons). The kernel of the
// engine here is pure-data and fully testable.

import type { AgentRun, AgentSpan } from '../contracts';
import type { Store, RunQuery } from '../infra/storage';
